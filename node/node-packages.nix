...
let
  sources = {
    "@babel/cli-7.1.5" = {
      ...
      src = fetchurl {
        ...
        sha512 = "zbO/DtTnaDappBflIU3zYEgATLToRDmW5uN/EGH1GXaes7ydfjqmAoK++xmJIA+8HfDw7UyPZNdM8fhGhfmMhw==";
      };
    };
    ...
    "@fortawesome/fontawesome-free-5.5.0" = {
      ...
      version = "5.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@fortawesome/fontawesome-free/-/fontawesome-free-5.5.0.tgz";
        sha512 = "p4lu0jfj5QN013ddArh99r3OXZ/fp9rbovs62LfaO70OMBsAXxtNd0lAq/97fitrscR0fqfd+/a5KNcp6Sh/0A==";
      };
    };
    ...
    "flow-bin-0.86.0" = {
      ...
      version = "0.86.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/flow-bin/-/flow-bin-0.86.0.tgz";
        sha512 = "ulRvFH3ewGIYwg+qPk/OJXoe3Nhqi0RyR0wqgK0b1NzUDEC6O99zU39MBTickXvlrr6iwRO6Wm4lVGeDmnzbew==";
      };
    };
    ...
    "foundation-sites-6.5.1" = {
      ...
      version = "6.5.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/foundation-sites/-/foundation-sites-6.5.1.tgz";
        sha512 = "Z+FiBvogwIDjRlefJ5pYkVcmsGx3pbndRJ80+OvPvI9UwfKCif6YtOyTxpCjUoS3XBlOms5vYonfnasp2V2wZw==";
      };
    };
    ...
    "jsuri-1.3.1" = {
      ...
      version = "1.3.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/jsuri/-/jsuri-1.3.1.tgz";
        sha1 = "cd93fc6a87b255142cb7b0f479f00517ab9395ed";
      };
    };
    "jwt-decode-2.2.0" = {
      name = "jwt-decode";
    ...
    "node-releases-1.0.4" = {
      ...
      version = "1.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-releases/-/node-releases-1.0.4.tgz";
        sha512 = "GqRV9GcHw8JCRDaP/JoeNMNzEGzHAknMvIHqMb2VeTOmg1Cf9+ej8bkV12tHfzWHQMCkQ5zUFgwFUkfraynNCw==";
      };
    };
    ...
    "uglifyjs-webpack-plugin-2.0.1" = {
      ...
      version = "2.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/uglifyjs-webpack-plugin/-/uglifyjs-webpack-plugin-2.0.1.tgz";
        sha512 = "1HhCHkOB6wRCcv7htcz1QRPVbWPEY074RP9vzt/X0LF4xXm9l4YGd0qja7z88abDixQlnVwBjXsTBs+Xsn/eeQ==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@fortawesome/fontawesome-free-5.5.0"
      ...
      sources."flow-bin-0.86.0"
      sources."flush-write-stream-1.0.3"
      sources."for-in-1.0.2"
      sources."foundation-sites-6.5.1"
      ...
      (sources."uglifyjs-webpack-plugin-2.0.1" // {
        dependencies = [
          sources."cacache-11.3.1"
          sources."find-cache-dir-2.0.0"
          sources."find-up-3.0.0"
